...
export class CreateAccountPage extends BasePage {
  ...
  constructor(page: Page) {
    super(page);
    this.getFirstNameInput = page.getByRole("textbox", {
      name: "First Name",
    });
    this.getLastNameInput = page.getByRole("textbox", {
      name: "Last Name",
    });
    this.getEmailInput = page.getByRole("textbox", { name: "Email" });
    this.getPasswordInput = page.getByRole("textbox", {
      name: "Password*",
      exact: true,
    });
    this.getConfirmPasswordInput = page.getByRole("textbox", {
      name: "Confirm Password",
    });
    this.getCreateAccountBtn = page.getByRole("button", {
